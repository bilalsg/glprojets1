...
const Navbar = ({className}:NavbarProps) => {
  ...
  return (
    <div className={`${className} flex z-50  justify-between items-center h-24 w-full  fixed backdrop-blur-md  bg-black/30  shadow-xl border-b-[2px] border-white/10	  px-[100px] text-white`}>
