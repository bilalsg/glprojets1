  ...
  return (
    <div className='w-full mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300 relative'>
      ...
      <div>
        ...
        <p className='py-4'>
          Bienvenue sur DZ Mohami, votre destination ultime pour des solutions numériques innovantes. Notre mission est de simplifier votre expérience en ligne en offrant des services de haute qualité dans le domaine du développement web, du design et de la technologie.
        </p>
