    ...
    <div className='w-full py-[10rem] px-4 bg-white '>
        ...
        <div className=' max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 group'>
            <div className='w-full shadow-2xl flex flex-col bg-gray-100 group-hover:blur-sm hover:!blur-none ho p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <h2 className='text-2xl font-bold text-center py-8 text-balck'>Single User</h2>
                <div className=' font-medium '>
                    <p className='py-2 border-b mx-8 mt-8'>professional lawyer</p>
                    <p className='py-2 border-b mx-8'>well rated </p>
                    <p className='py-2 border-b mx-8'>all information below</p>
                    <div className='flex gap-2 px-6'>
                    <button className='bg-gray-900 hover:bg-red-700 text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
                    <button className='border-2 border-red-700 hover:bg-red-700 text-black hover:text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
                    </div>
                </div>
            </div>
            ...
            <div className='w-full shadow-2xl flex flex-col bg-gray-100 p-4 my-4 group-hover:blur-sm hover:!blur-none rounded-lg hover:scale-105 duration-300'>
                ...
                <div className=' font-medium '>
                    ...
                    <div className='flex gap-2 px-6'>
                    <button className='bg-gray-900 hover:bg-red-700 text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
                    <button className='border-2 border-red-700 text-black hover:bg-red-700  hover:text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
                    </div>
                </div>
            </div>
            <Select />
